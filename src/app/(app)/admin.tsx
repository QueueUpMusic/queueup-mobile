...
const capabilities: Capability[] = [
  ...
  { title: 'Countdowns', description: 'Native countdown management is coming soon.', icon: 'countdowns', available: false },
  { title: 'Notifications', description: 'Native notification management is coming soon.', icon: 'notifications', available: false },
];
