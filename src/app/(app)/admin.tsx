...
export default function AdminScreen() {
  ...
  return <View style={styles.screen}>
    ...
    <ScrollView contentContainerStyle={styles.content} refreshControl={<RefreshControl colors={[colors.brand]} onRefresh={() => void load(true)} refreshing={refreshing} tintColor={colors.brand} />}>
      ...
      <View style={styles.metrics}><Metric label="Players" value={overview?.user_count} /><Metric label="Seasons" value={overview?.season_count} /><Metric label="Rounds" value={overview?.round_count} /><Metric label="Badges" value={overview?.badge_count} /><Metric label="Mobile devices" value={overview?.native_device_count} /><Metric label="Web subscriptions" value={overview?.legacy_web_subscription_count} /></View>
