...
const styles = StyleSheet.create({
  ...
  rankRow: { alignItems: 'center', borderBottomColor: colors.borderSoft, borderBottomWidth: StyleSheet.hairlineWidth, flexDirection: 'row', gap: Spacing.sm, minHeight: 78, paddingHorizontal: Spacing.lg, paddingVertical: Spacing.md },
  ...
  playerCopy: { flex: 1, gap: 3, marginLeft: Spacing.sm, minWidth: 0, overflow: 'hidden' },
